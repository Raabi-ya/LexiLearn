    ...
    datasets: [
      {
        label: 'Level Scores',
        data: [
          userData ? userData.level1.reduce((acc, curr) => acc + curr, 0) : 0,
          userData ? userData.level2.reduce((acc, curr) => acc + curr, 0) : 0,
          userData ? userData.level3.reduce((acc, curr) => acc + curr, 0) : 0,
          userData ? userData.level4.reduce((acc, curr) => acc + curr, 0) : 0, 
        ],
        fill: false,
